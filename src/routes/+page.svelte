<script>
	...
	let questions = [
		...
		{
			title: 'Loremmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm'
		}
	];
...
<main class="flex min-h-dvh flex-col items-center justify-start p-8 font-propmt">
	...
	<h1 class="text-4xl font-bold text-primary-500 text-start w-full my-4 hidden md:block">Welcome back, USERNAME</h1>
